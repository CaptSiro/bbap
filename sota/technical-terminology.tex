...
In this thesis LLM and AI is used interchangeably and refers to software that returns text response from natural language request.
Large Language Models are transformer-based language models that are pre-trained on web-scale corpora.
These models are capable of obtaining world knowledge, generating code, following instructions, self-improved, and other~\parencite{minaee2025_llm_suvey}.
