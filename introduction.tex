...
Building a feature-complete full-stack framework requires strong foundation in architecture and focus on implementing
many features as soon as possible, and thus they sacrifice architectural design.
...
\begin{itemize}
    ...
    \item Achieving strong architecture requires implementing all features by hand and avoiding reliance on third-party libraries.
