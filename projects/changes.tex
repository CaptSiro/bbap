\section{Common Manual Interventions}\label{sec:common-manual-interventions}
This section is going to address several common changes, that can be applied to the framework.

\subsection*{Adding Meta Description to Homepage}
...
Meta description, editable through web settings, can be added this way:
...
\subsection*{Editing Homepage Button Behavior}
...
Drag-and-dropping is currently the only way to upload files to the system.

\subsection*{Changing Homepage Image}
...
\subsection*{Creating Editor User}
