...
\section*{Hypothesis Evaluation}\label{sec:hypothesis-evaluation}
The observations during implementation and evaluation results generally support the hypotheses proposed in Chapter~\ref{sec:introduction-hypothesis}.
...
\section*{Requirements Evaluation}\label{sec:requirements-evaluation}
...
During implementation and evaluation actions performed by the framework did not exceed the expected time to fulfill the request,
...
\section*{Limitations of the Prototype}\label{sec:limitations-of-the-prototype}
