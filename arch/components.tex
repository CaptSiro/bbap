...
The database layer implements ORM built from ground up to fit the system needs.
Some ORMs have been reviewed and the abstractions used did not fit the style of the system and most of the features
that the abstractions enabled would not be used wither way.
