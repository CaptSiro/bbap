...
At a high level, the system accepts requests and based on them generates appropriate response.
...
table listing of records from collection, creation of new records, and editing of existing records.
The dashboard also provides system utilities and for the developers web view for results from tests.
