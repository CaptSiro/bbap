...
which is reflected by closed-source nature.
This makes it is great for less tech-savvy users, but lacks in flexibility for teams of developers.
...
while providing easy to use interface like the one Squarespace defines.
