...
The process may result in failure at any point of the execution, it is terminated immediately, and response
containing failure details is sent to the user.
...
If no failures are encountered, successful response is generated from all the gathered inputs and sent.
